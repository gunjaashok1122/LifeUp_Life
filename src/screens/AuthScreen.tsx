...
Once you reset your password, log in with it and the app will automatically migrate your account so future resets are 100% in-app via OTP!`);
  ...
  return (
    <div className="min-h-full w-full flex flex-col items-center justify-center p-4 relative overflow-hidden bg-[#070b13]">
      ...
      {/* Main Container */}
      <div className="w-full max-w-md p-5 rounded-3xl border border-rpg-border/30 bg-rpg-card/40 backdrop-blur-xl shadow-glass flex flex-col relative z-10">
        
        {/* App Title & Logo */}
        <div className="flex flex-col items-center mb-3">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-rpg-xp to-rpg-level flex items-center justify-center shadow-lg shadow-rpg-level/20 mb-2 animate-float">
            <Shield className="w-6 h-6 text-white stroke-[2]" />
          </div>
          <h1 className="text-2xl font-extrabold tracking-tight text-white font-sans bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400">
            LevelUp Life
          </h1>
          <p className="text-[10px] font-semibold text-rpg-discipline uppercase tracking-widest mt-1 flex items-center gap-1">
            <Sparkles className="w-3 h-3" /> Gamify Your Discipline OS
          </p>
        </div>
        ...
        <div className="space-y-2">
          <button
            ...
            disabled={isWorking}
            className="w-full py-2.5 rounded-xl bg-white text-slate-900 hover:bg-slate-100 text-xs font-bold transition-all flex items-center justify-center gap-2 disabled:opacity-50 active:scale-95"
          >
